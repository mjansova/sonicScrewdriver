#ifndef Plot1DSuperimposedNoNorm_h
#define Plot1DSuperimposedNoNorm_h
...
#define DONORMALIZE 0

namespace theDoctor
{

    class Plot1DSuperimposedNoNorm
    {

     public:

      Plot1DSuperimposedNoNorm();
      ~Plot1DSuperimposedNoNorm();
                           ...
                           OptionsScrewdriver theGlobalOptions)
      {
         ...
         string plotName = string("t:1DSuperimposedNoNorm|v:")+theVar->getTag()
                                                 +"|r:"+theRegion->getTag()
                                                 +"|c:"+theChannel->getTag();

         Plot thePlot(plotName,"1DSuperimposedNoNorm",theGlobalOptions,"");
         ...
         bool includeSignal = theGlobalOptions.GetGlobalBoolOption("1DSuperimposedNoNorm","includeSignal");
         bool includeData   = theGlobalOptions.GetGlobalBoolOption("1DSuperimposedNoNorm","includeData");
